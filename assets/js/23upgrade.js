$(document).ready(function () {
  ...
  console.log("2023 page open");

  $.ajax({
    url: "queries/2023_upgrades.php",
    type: "GET",
    ...
    success: function (response) {
      ...
      response.forEach((member) => {
        ...
        if (sapDate && sapDate.startsWith("2023")) {
          sapMembers.push(member);
        }

        if (esapDate && esapDate.startsWith("2023")) {
