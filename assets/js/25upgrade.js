$(document).ready(function () {
  ...
  console.log("2025 page open");

  $.ajax({
    url: "queries/2025_upgrades.php",
    type: "GET",
    ...
    success: function (response) {
      ...
      response.forEach((member) => {
        ...
        if (sapDate && sapDate.startsWith("2025")) {
          sapMembers.push(member);
        }

        if (esapDate && esapDate.startsWith("2025")) {
